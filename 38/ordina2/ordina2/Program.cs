...
namespace ordina2
{
    class Program
    {
        ...
        static void inserisci_dati(string[] nomi)
        {
        ...
        static void stampa_a_video(string[] nomi)
        {
            int n = nomi.Length;
            for (int i = 0; i <= n - 1; i++)
            {
        ...
        static void ordina(string[] nomi)
        {
        ...
        static void Main(string[] args)
        {
            ...
            int n = Convert.ToInt32(Console.ReadLine()); //faccio inserire all'utente il numero di nomi per poi convertirlo
            string[] nomi;  //dichiaro un array
            nomi = new string[n]; //istanzio l'array         
            inserisci_dati(nomi);  //chiamo la funzione che fa inserire all'utente i nomi 
            ...
            stampa_a_video(nomi);//chiamo la funzione per stampare i nomi a video
            ...
            ordina(nomi); // chiamo la funzione per ordinare i nomi
            stampa_a_video(nomi); // richiamo la funzione per la seconda volta per poter stampare i nomi
